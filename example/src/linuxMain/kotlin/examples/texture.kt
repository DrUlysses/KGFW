...
import kgfw.image.DecodedImage
...
private fun downsampleRGBA(source: DecodedImage, limit: Int): DecodedImage {
    var targetWidth = source.width
    var targetHeight = source.height
    
    // Scale down to the limit
    ...
    // Further scale down to the nearest power of two for maximum compatibility with legacy OpenGL
    ...
    return DecodedImage(newData, targetWidth, targetHeight)
}
